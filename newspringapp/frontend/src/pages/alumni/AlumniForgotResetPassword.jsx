...
const AlumnForgotResetPassword = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      setLoading(true);
      const response = await verifyAlumniOtp({ email, otp });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      setLoading(true);
      await resetAlumniPassword({ email, otp, newPassword });
...
export default AlumnForgotResetPassword;
